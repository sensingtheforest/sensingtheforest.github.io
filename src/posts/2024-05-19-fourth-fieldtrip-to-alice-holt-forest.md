...
Still, there is a lot of work to do. In our next field trip related to the streamers, we should explore a third dongle (that should be plug-and-play), increase the lifespan of the battery, swap the SIM card to a 1-year SIM card plan and add remote monitoring features.
