...
Thanks a lot to George Xenakis and Michael Bell from Forest Research for their practical, experience-based suggestions, which consistently proved accurate and saved us a great deal of trial and error.
...
However, their low current draw made them **very sensitive to interference**. Here's what that sounded like:
...
No sonograph allowed! Dear DIYer: if I say *“the audio here isn’t good”* but it sounds fine to you, you can skip the impriovements I suggest.

**MEMS were a bumpy ride.**

**Step one: just make it work.**
...
**Next step: do things a little better.**
Bit resolution is still mismatched, *but* now the cables are shielded, with the shield connected only on the Raspberry Pi side (joined to ground along with the cable ground).
...
ALSA can be a bit unforgiving. If you don’t know the exact bit format of your device (not just the depth, but the label), it’s a real problem. Ironically, to figure it out for sure, you’ll probably need tools that come with PipeWire. But if you don’t want to install all that, a few educated guesses will often get you through.

**Now that the mic sounds decent, time to plug in the modem and head to the forest?**
Not so fast...
