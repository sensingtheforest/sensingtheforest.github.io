...
# A DIY Solar-Powered Audio Streamer that Can Record Samples at Solar Times
...
* [ ] 4 × 100W solar panels (we used Eco-Worthy)
...
> **Note**: These configurations worked for our specific conditions. Solar requirements vary enormously based on region, sunlight exposure, and shading. For detailed explanation, refer to the relevant section in the guide.
...
* [ ] 1 × 100kΩ resistor
* [ ] 1 × 330kΩ resistor
* [ ] Small breadboard (with vertical layout preferred)
...
Instead of a simple `ps aux | grep darkice` process check (which often fails in edge cases), we implemented **live terminal parsing** of Darkice's output:

* If output ends with `SCHED_FIFO` → everything is fine, set streamer state to `1`
* If keywords like `reconnecting  0` or `TcpSocket` appear → set state to `0`, even if it later recovers
...
During field testing, we noticed Darkice could remain an active process but **fail silently** — e.g., not actually streaming due to a network dropout or crash. Live output parsing fixed that.
...
Magically, restarting Darkice often kicked the server back to life. Why? No idea. Maybe it reset the transmission protocol. Maybe it was just scared of getting rebooted again. It worked, and that’s what counts.
...
In winter? You might need four 100W panels — 400W total — and a 120AH deep-cycle battery just to keep a device drawing 0.2A online.
...
<table>
  <tr>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_103910_full.jpg" width="300"/><br/>Direct sunlight - panel</td>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_103932_full-m.jpg" width="300"/><br/>Direct sunlight - voltage reading</td>
  </tr>
  <tr>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_111607_partial.jpg" width="300"/><br/>Partial shade - panel</td>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_111619_partial-m.jpg" width="300"/><br/>Partial shade - voltage reading</td>
  </tr>
  <tr>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_112557_covered.jpg" width="300"/><br/>Shade - panel</td>
    <td align="center"><img src="2025-07-10-tutorial-3-images/IMG_20241129_112613_covered-m.jpg" width="300"/><br/>Shade - voltage reading</td>
  </tr>
</table>
...
The angle of the solar panel matters more than you'd think. You want the sunlight to hit it as close to perpendicular as possible.

<table>
  <tr>
    <td align="center"><img src="2025-07-10-tutorial-3-images/panel-inclin_winter.jpg" width="200"/><br/><strong>Winter</strong><br/>Nearly vertical</td>
    <td align="center"><img src="2025-07-10-tutorial-3-images/panel-inclin_spring-autumn.jpg" width="200"/><br/><strong>Autumn/Spring</strong><br/>Around 60°</td>
    <td align="center"><img src="2025-07-10-tutorial-3-images/panel-inclin_summer.jpg" width="200"/><br/><strong>Summer</strong><br/>Around 45°</td>
  </tr>
</table>
...
![Volt graph test](2025-07-10-tutorial-3-images/tutorial3_volt-graph-1.png)
...
* In a partially open site (like in our test photos), **400W worth of panels** was needed to stay online reliably.
