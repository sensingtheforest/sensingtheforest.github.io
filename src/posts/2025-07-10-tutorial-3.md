...
On the left is a single mic, which I secure to the 3D-printed socket with hot glue. On the right are the two ends of the left and right mics, twisted together and crimped with the same connector. If you’re thinking in terms of analog audio, this might seem counterintuitive, but this is digital. Yes, L and R share some joined cables, yet you’ll still get separate channels on the Raspberry Pi — as long as you solder the R channel control pin to Vdd and the L channel control pin to ground.
