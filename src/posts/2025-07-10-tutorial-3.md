...
In the right photo you can see a design detail: the lid has small semicircles with a downward-facing rim. They act like mini-umbrellas for the cable notch, and the rim presses down on the cables so raindrops can’t slide along them into the box (since, well, gravity wants the water to go from top to bottom).
