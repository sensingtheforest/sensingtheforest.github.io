...
For the assembly of the actual streamer with the microphones and the battery sensor, see the following sections. Also, when the current is converted from the direct wore of the car battery to something menagable for the RPi, mistakes are less critical, so feel free to try different solutions!
