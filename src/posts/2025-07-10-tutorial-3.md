...
#### Downloads
FreeCAD:<br>
[All](../assets/freecad/streambox-ads1115-rpiVert-10cm_FINAL.FCStd)<br>

Meshes:<br>
[Case](../assets/freecad/)<br>
[Lid](../assets/freecad/)<br>
[Mic Holder (Lavalier)](../assets/freecad/)<br>
[Mic Holder (MEMS)](../assets/freecad/)<br>
[Modem Mushroom Case (dongles)](../assets/freecad/)<br>
[Modem Case (SIM7600)](../assets/freecad/)
...
Question: will PLA survive the rain and the sun for one year in the forest?
The internet: NO!
ChatGPT: NO!

My tests: well...

Fisrt, if you're using cheap maerials and you can check now and then if the situation is deteriorating, why not just trying to use more eco-friendly materials? 

To be on the safe side, I coated the back of the lid with beewax 

PIC

I tested it under the shower to be sure that the top and the design provided protection from water coming from above. It was fine.
But the problem with PLA is that it wears outdoor with the sun light and ... 
BUT - The last version stayed there from November to August (sun, rain and snow) and not a single drop of water penetrated the lid. It doesn't look to banged up either...
