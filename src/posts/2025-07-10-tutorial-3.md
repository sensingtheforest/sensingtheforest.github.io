...
Here’s an edited and clearer version of your section, keeping the technical depth and improving readability and structure:
...
> **Note:** The Rode AI-Micro comes — strangely — set to mix the left and right channels into mono by default. If you're using it, make sure to reconfigure it using the provided software. This has to be done from a non-Linux machine.

This is the audio setup I used to record all the audio files you can hear on Free Sound (link) **from March onward**.
