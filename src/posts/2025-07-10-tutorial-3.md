...
Don't assume that in 2025, all remote areas have some sort of network coverage.
Alice Holt is a 

Make sure you understand the risks associated with leaving a 12V battery... In what follows, I'll repeat to use a fuse, but it's good to start here: **make sure to test your equipment enclosure under water and direct sunlight, and use a fuse like shown in the main diagram** 
