---
title: Phase 2 - A DIY Solar-Powered Home LAN Audio Streamer that Can Record Samples at Solar Times
date: 2025-12-18T10:00:00.000Z
excerpt: In this tutorial, I’ll walk you through the minimal steps to build a solar-powered home LAN streamer that can also automate recordings based on solar time.
permalink: /streamers/tutorial-2/
author: luigi-marino
draft: false
seo:
  title:
  description:
  image: 2025/12/birdfeeder.jpg
images: # relative to /src/assets/images/
  feature: 2025/12/birdfeeder.jpg
  thumb: 2025/12/birdfeeder.jpg
...
If you see something like USB Audio or the name of your device, you’re ready to move on to the software setup.

For the MEMS microphones, below a quick diagram illustrating the connections in a stereo configuration. (And yes... the wires aren't exactly drowing contest material...)


![mems-wires](/assets/images/2025/12/mems-wires-2.jpg)

Connect the MEMS microphones and proceed with the software setup — they aren’t plug-and-play, so we'll need the linux kernel headers and the drivers.
...
![case1](/assets/images/2025/12/case1.jpg)

The first is ultra-compact and fits only the RPi Zero, with just enough room for the header connections.
  
* [RPi0-Case1_FreeCAD-Project](/assets/3d-print/rpi-zero_suction-cup-1.FCStd)

<br />

#### Meshes

* [Case1-Top](/assets/3d-print/rpi0-case_suctioncap-1_TOP.stl)
* [Case1-Bottom](/assets/3d-print/rpi0-case_suctioncap-1_BOTTOM.stl)

<br />

### Design Option 2

![case2](/assets/images/2025/12/case2.jpg)

The second also includes space for an ADS1115 battery sensor — very handy when running on solar power!

And should you ask the following research question: “Why does it look like a throwback to 90s hip-hop???”

We can only hope that future research and the advancement of cutting-edge technologies, will one day shed light on this most essential inquiry.

* [RPi0-Case1_FreeCAD-Project](/assets/3d-print/rpi0-case_ads1115_suction-cup.FCStd)

<br />

#### Meshes

* [Case2-Top](/assets/3d-print/rpi0-case_ads1115_suction-cup_TOP.stl)
* [Case2-Bottom](/assets/3d-print/rpi0-case_ads1115_suction-cup_BOTTOM.stl)

## Software setup

Just a slightly more commented version of the steps described in our [README.md](https://github.com/sensingtheforest/audio-streamer/blob/main/README.md) file in the repo.
...
Our code automatically records 5-minute samples at sunrise, solar noon, sunset, and once during the night (between sunset and sunrise). You'll find the wav files inside `audio-streamer/audio`.

You can adjust the solar times in `solar-crontab.py`, and change the recording duration in `common.sh`, where you’ll also find several other system parameters. Using these parameters, you can deactivate the recording feature by changing `RECORD=1` to `RECORD=0` (you'll need to reboot, or manually kill the active record screen session). For more details, refer again to the [advanced tutorial](https://sensingtheforest.github.io/streamers/tutorial-3/).

And yes, after more than 800 hours of uninterrupted, solar-powered streaming and recording, I’d say it’s safe to call it reliable 🎉

![case2](/assets/images/2025/12/Screenshot.png)
