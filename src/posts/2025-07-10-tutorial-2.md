...
This part is mostly up to you! If you’re feeling adventurous and want to learn how to build the movable mic cases shown in the pictures, the RPi case, or add a battery sensor, check out the [more advanced tutorial](https://sensingtheforest.github.io/streamers/tutorial-3/).

For those projects, you’ll need 3D printing capabilities. Below are models for two case designs with suction cups for window mounting:

* The first is ultra-compact and fits only the **RPi Zero**, with just enough room for the header connections.
* The **second** also includes space for a **battery sensor** — very handy when running on solar power!

Here’s a quick diagram showing the **MEMS microphone connections** in a **stereo configuration**. For a deeper explanation and tips on improving audio quality, refer again to the [advanced tutorial](https://sensingtheforest.github.io/streamers/tutorial-3/).


## Software setup

This is just a slightly more commented version of the steps described in our README.md file in the repo.
