...
[RPi0-Case1_FreeCAD-Project](../../src/assets/3d-print/rpi-zero_suction-cup-1.FCStd)<br />

Meshes:<br />
[Case-Top](../../src/assets/3d-print/rpi0-case_suctioncap-1_TOP.stl)<br />
[Case-Bottom](../../src/assets/3d-print/rpi0-case_suctioncap-1_BOTTOM.stl)<br />
...
Here’s your paragraph, slightly polished for rhythm and clarity while keeping your warm, maker-style tone — and the 🎉 stays, of course:

---

Our code automatically records 5-minute samples at sunrise, solar noon, sunset, and once during the night (between sunset and sunrise). You'll find them in inside `audio-streamer/audio`
...
![case2](../../src/assets/images/2025/07/Screenshot.png)
