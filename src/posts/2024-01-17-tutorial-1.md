...
`-channel_layout stereo` isn't necessary but ffmpeg doesn't seem to like the mono mic and, without the layout, sends out warnings and uses stereo either way duplicating the channel.
