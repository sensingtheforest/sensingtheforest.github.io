...
The project will run from 2023 to 2025 in the [Music, Technology and Innovation - Institute of Sonic Creativity (MTI2)](https://www.dmu.ac.uk/research/research-faculties-and-institutes/technology/mtirc/staff.aspx) at the Leicester Media School (LMS), Faculty of Computing, Engineering and Media (CEM) at De Montfort University (DMU) in partnership with [Forest Research](https://www.forestresearch.gov.uk/) and [Forestry England](https://www.forestryengland.uk/). To meet the team, visit the [About webpage](/about). 
